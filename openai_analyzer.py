...
def generate_topic_candidates_ai(
    ...
    prompt = (
        ...
        "         ⑥ 一般論品質ゲート（以下はすべてNGとして作り直す）:\n"
        "            NG: 「むくみにはマッサージ」「紫外線対策をしましょう」のような一般的美容アドバイス\n"
        "            NG: CORE HARI独自視点（咬筋/舌/首/頭皮/表情筋/顎/呼吸/姿勢）が入っていないHook\n"
        "            NG: 読者が「知らなかった」と思えない内容\n"
        "            NG: 医学的断定（「〜が原因です」「〜は必ずなります」）\n"
        "         ⑦ おすすめ1位（stars=5）が一般論品質ゲートで落ちた場合は必ず作り直す\n\n"
